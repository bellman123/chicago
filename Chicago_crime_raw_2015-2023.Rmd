...
#should just join above into desired columns, leave NA for those w/o those columns, and then join that to community_crime_yr summary to get data instead of going year by year
